...
describe ('streakCounter', () => {
    ...
    it('should return a streak with a currentCount, startDate and lastLoginDate', () => {
        const date = new Date();
    ...
    describe('with a pre-populated streak', () => {
        ...
        beforeEach(() => {
            ...
            // Use date in the past so it's always the same
        ...
        it('should increment the streak', () => {
            // It shoudl increment because this is the day after the streak
            // started and a streak is days in a row.
        ...
        it('should not increment the streak when login days not consecutive', () => {
            // It should not increment because this is two days after the streak
            // started and the days aren't consecutive
